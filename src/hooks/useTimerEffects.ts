...
export const useTimerEffects = (state: TimerState, controls: TimerControls) => {
  ...
  useEffect(() => {
    // Create "Go" sound for start - using a Base64 encoded audio of someone saying "Go"
    const startSound = new Audio();
    startSound.src = 'data:audio/mp3;base64,';
    
    // Create whistle sound for end - using a Base64 encoded sports whistle sound
    const endSound = new Audio();
    endSound.src = 'data:audio/mp3;base64,';
